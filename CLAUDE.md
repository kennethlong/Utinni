...
opinion without leaving the session — use the bare **`sonnet`** alias (always resolves to the latest
Sonnet) and Opus for the heaviest reviews. Don't pin a dated Sonnet id; the alias tracks the current model.
