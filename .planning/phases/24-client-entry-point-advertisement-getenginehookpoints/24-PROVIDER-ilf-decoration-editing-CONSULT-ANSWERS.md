> **Utinni-copy note (2026-07-19):** this memo is addressed to the SWG-Toolkit live-editor session but applies equally to Utinni — both consumers bind the same v21 contract, the decisive experiment runs identically on UtinniCore, and the v21 re-sync ask in §"What we're asking" IS the UtinniCore maintainer's item. The companion synthesis + the hybrid in-cell ANSWERS are mirrored alongside this file (24-PROVIDER-CONSULT-69-SYNTHESIS-copy.md / 24-PROVIDER-CONSULT-hybrid-incell-ANSWERS.md).
