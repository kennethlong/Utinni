...
**Success Criteria** (what must be TRUE):
  1. The overlay renders and maps input in render-target space under D3D11 — `Dx11Backend` hooks `IDXGISwapChain::Present` (vtbl idx 8), acquired from a throwaway `D3D11CreateDeviceAndSwapChain`, with a per-frame backbuffer-RTV rebind.
...
| 17. CppSharp / v145 Hardening | v2.1 | 1/3 | In Progress|  |
